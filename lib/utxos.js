...
class UTXOs {
  ...
  async initUtxoStore (addr) {
    try {
      ...
      // For debugging
      // console.log(`utxoStore: ${JSON.stringify(_this.utxoStore, null, 2)}`)
      // console.log(`bchUtxos: ${JSON.stringify(_this.bchUtxos, null, 2)}`)
      // console.log(`tokenUtxos: ${JSON.stringify(_this.tokenUtxos, null, 2)}`)
